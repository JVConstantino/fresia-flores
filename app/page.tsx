        ...
        <section className="py-14 sm:py-24 px-4 sm:px-6 max-w-7xl mx-auto">
          ...
          <div className="flex gap-3 overflow-x-auto pb-2 lg:hidden snap-x snap-mandatory">
            {categories.slice(0, 6).map((cat) => (
              <Link key={cat.id} href={`/loja?cat=${cat.slug}`} className="snap-start flex-shrink-0 w-44 h-52 rounded-lg overflow-hidden relative bg-ink-100">
                {(cat as any).imageUrl ? (
            ...
            <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 sm:gap-8 mb-8 sm:mb-12">
              ...
              <div className="text-right">
                ...
                {promoProducts.length === 8 && (
                  <Link href="/loja" className="text-sm font-semibold text-lilac-600 hover:text-lilac-700 underline underline-offset-2">
      ...
      {blogPosts.length > 0 && (
        <section className="py-14 sm:py-24 px-4 sm:px-6 max-w-7xl mx-auto">
          <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-3 sm:gap-8 mb-8 sm:mb-10">
            ...
            <Link href="/blog" className="text-sm font-semibold text-lilac-600 hover:text-lilac-700 underline underline-offset-2">
              Ver todos os posts →
            </Link>
          </div>
