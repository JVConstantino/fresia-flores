  ...
  return (
    <>
      ...
      <section className="py-16 px-6 bg-ink-50">
        <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <Link href="/loja" className="inline-block px-6 py-3 bg-lilac-500 hover:bg-lilac-600 text-white rounded-xl font-medium text-sm transition-colors">
              Explorar nossa loja
            </Link>
          </div>
      ...
      <section className="py-16 px-6 bg-gradient-to-r from-lilac-500 to-petal-400 text-white text-center">
        ...
        <Link href="/contato" className="inline-block px-8 py-3 bg-white text-lilac-600 font-semibold rounded-xl hover:bg-ink-50 transition-colors">
          Falar conosco
        </Link>
      </section>
    </>
