...
exports.mercadoPagoService = {
    ...
    detectBrand(cardNumber) {
        ...
        if (binNum >= 400000 && binNum <= 499999)
            return 'visa';
        if (binNum >= 500000 && binNum <= 559999)
            return 'mastercard';
        if (binNum >= 636214 && binNum <= 636215)
            return 'elo';
        if (binNum >= 506629 && binNum <= 506778)
            return 'elo';
        if (binNum >= 384100 && binNum <= 384800)
            return 'hipercard';
        if (binNum >= 300000 && binNum <= 305999)
            return 'amex';
        return 'unknown';
    },
    /**
